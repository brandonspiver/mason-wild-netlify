...
const variants: Record<Variant, string> = {
  ...
  ghost:
    "text-stone-600 hover:text-stone-900 border-b border-stone-300 hover:border-stone-900 pb-[2px]",
  "ghost-light":
    "text-white/70 hover:text-white border-b border-white/28 hover:border-white/65 pb-[2px]",
  "outline-light":
