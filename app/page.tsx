      ...
      >
        ...
        <Reveal delay={1}>
          <div className="flex flex-col justify-center px-[clamp(40px,6vw,80px)] py-[clamp(48px,7vw,96px)]">
            <p className="label-tag mb-7">{FOUNDER.title}</p>
            <h2
            ...
            <a
              ...
              className="inline-flex items-center text-2xs uppercase tracking-[0.12em] text-stone-500 border-b border-stone-300 hover:text-stone-900 hover:border-stone-900 pb-[2px] transition-colors duration mb-10"
            >
              Connect with Zannon on LinkedIn
            </a>
            <Button
        ...
        <div className="container-site">
          ...
          <div className="grid grid-cols-1 gap-px border border-white bg-white md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              "Supplier and routing selection based on fit, not inventory pressure.",
